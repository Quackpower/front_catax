...
var responseSend;
var folio;
var serv = "https://sirac.cmas-coatepec.gob.mx/";
    ...
    $(document).on('click', '.selectCategoria', function() {
        ...
        for (var x = 0; x < dataInicial.subcategorias.length; x++) {
            if ($(this).attr('id').replace(/ /g, '_') == dataInicial.subcategorias[x]['categorias'].replace(/ /g, '_')) {
                ...
                var imga = "<img src=data:image/png;base64," +dataInicial.subcategorias[x]['icono'].split("'")[1]+">"
        ...
        if(window.screen.width<968){
            $('.shape-box_half').addClass('hovered')
        }
